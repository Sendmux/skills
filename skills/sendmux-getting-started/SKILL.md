...
7. Save the agent credential bundle in a secure store before reporting success, then exchange the returned `identity_assertion` with `POST /agent-auth/oauth2/token`.
