...
description: "Use when a user wants to give an AI agent an inbox, receive or triage mail, draft approved replies, send notifications after owner approval, or build an agent email workflow even when Sendmux is not named."
license: Apache-2.0
metadata:
  author: sendmux
  version: "1.0"
